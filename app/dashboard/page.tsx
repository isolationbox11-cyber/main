    ...
    <div className="flex-1 space-y-6 p-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-muted-foreground">August 3, 2025</span>
          <span className="text-sm text-blue-500">👁️ Security Watch Active</span>
        </div>
      </div>
      ...
      {/* Security Promotion Card */}
      <Card className="border-blue-500/30 bg-gradient-to-r from-black to-blue-950">
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            <div className="text-4xl animate-float">👁️</div>
            <div className="flex-1">
              <h3 className="text-xl font-bold text-blue-400 mb-2">Security Watch Special</h3>
              <p className="text-muted-foreground mb-4">
                Enhance your digital security with advanced surveillance features! Get our premium security package with continuous monitoring.
              </p>
            </div>
            <div>
