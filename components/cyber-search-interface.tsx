...
export function CyberSearchInterface() {
  ...
  return (
    <div className="space-y-6">
      <Alert className="border-blue-500/30 bg-gradient-to-r from-black to-blue-950 text-blue-100">
        <Lightbulb className="h-4 w-4 text-blue-400" />
        <AlertDescription className="flex items-center justify-between">
          <span>
            <span className="text-blue-400 font-bold">👁️ Cyber Watch Vault</span> allows you to search the dark corners of the internet safely. 
            Venture through our digital surveillance to discover devices and services lurking in the web&apos;s shadows.
          </span>
        </AlertDescription>
      </Alert>

      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="bg-black border border-blue-900/50 mx-auto mb-4">
          ...
          <TabsTrigger value="advanced" className="data-[state=active]:bg-blue-900/30 data-[state=active]:text-blue-400">
            <Eye className="h-4 w-4 mr-2" />Advanced Searches
          </TabsTrigger>
          <TabsTrigger value="learn" className="data-[state=active]:bg-blue-900/30 data-[state=active]:text-blue-400">
            <Shield className="h-4 w-4 mr-2" />Security Guide
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="search" className="space-y-4">
          ...
          <Card className="border-blue-500/30 bg-gradient-to-r from-black to-blue-950">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-blue-400">
                <Search className="h-5 w-5" />Digital Intelligence Scanner
              </CardTitle>
              <CardDescription className="text-blue-300/70">
                Search for devices, servers, and digital entities within the network perimeter
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-black/50 border-blue-900/50 text-blue-100 placeholder:text-blue-300/50 focus-visible:ring-blue-500/30 focus-visible:border-blue-500/50"
                    onKeyPress={(e) => e.key === "Enter" && handleSearch()}
                  />
                </div>
                <Button 
                  onClick={handleSearch} 
                  className="bg-blue-600 hover:bg-blue-700 animate-pulse shadow-[0_0_10px_rgba(37,99,235,0.5)]"
                >
              ...
              {/* Advanced Filters */}
              {showAdvanced && (
                <div className="grid gap-4 md:grid-cols-3 p-4 border rounded-lg border-blue-900/50 bg-black/30">
                  <div className="space-y-2">
                    <Label className="text-blue-300">🌍 Country</Label>
                    <Select value={selectedCountry} onValueChange={setSelectedCountry}>
                      <SelectTrigger className="bg-black/50 border-blue-900/50 text-blue-100 focus-visible:ring-blue-500/30">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className="bg-black/50 border-blue-900/50 text-blue-100 placeholder:text-blue-300/50 focus-visible:ring-blue-500/30 focus-visible:border-blue-500/50"
                    />
                  </div>
                </div>
              )}
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card className="border-blue-500/30 bg-gradient-to-r from-black/80 to-blue-950/30">
              <CardHeader>
            ...
            <Card className="border-blue-500/30 bg-gradient-to-r from-black/80 to-blue-950/30">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center p-3 border border-blue-500/20 rounded-lg bg-black/30 animate-pulse">
                  <div className="mr-3 text-xl">🔍</div>
                  <div className="flex-1">
                    <h4 className="text-sm font-medium text-blue-400">Security Update Alert</h4>
                    <p className="text-xs text-blue-300/70">
                      New vulnerability detected in IoT doorbell cameras that could allow unauthorized access
                    </p>
                  </div>
                  <Badge variant="outline" className="border-blue-500/50 text-blue-400 bg-black/30">New</Badge>
                </div>
                ...
                <div className="flex items-center p-3 border border-blue-900/30 rounded-lg">
                  ...
                  <Badge variant="outline" className="border-blue-500/50 text-blue-400 bg-black/30">High</Badge>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <TabsContent value="advanced" className="space-y-4">
          <Card className="border-blue-500/30 bg-gradient-to-r from-black to-blue-950">
            <CardHeader>
              <CardTitle className="text-lg text-blue-400 flex items-center gap-2">
                <Eye className="h-5 w-5" /> Advanced Search Patterns
              </CardTitle>
              <CardDescription className="text-blue-300/70">
                Advanced search patterns for finding specific types of exposed devices
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Badge variant="outline" className={`
                          border-blue-500/50 bg-black/30
                      ...
                      <code className="text-xs bg-black/50 px-2 py-1 rounded text-blue-300">{dork.query}</code>
          ...
          <Card className="border-blue-500/30 bg-gradient-to-r from-black/80 to-blue-950/30">
            <CardHeader>
              <CardTitle className="text-blue-400">⚠️ Warning: Digital Security Safety</CardTitle>
              <CardDescription className="text-blue-300/70">
                Security scanning requires caution and ethical practice
              </CardDescription>
            </CardHeader>
            <CardContent className="prose prose-invert max-w-none">
              <div className="p-4 border border-red-900/50 rounded-lg bg-black/30">
                <h4 className="text-red-400 text-lg mt-0">The Security Researcher's Code</h4>
                ...
                <div className="mt-4 text-sm text-blue-300/70">
                  Remember: With great power comes great responsibility. Use Cyber Watch Vault for education and legitimate security research only.
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="learn" className="space-y-4">
          <Card className="border-blue-500/30 bg-gradient-to-r from-black to-blue-950">
            <CardHeader>
              <CardTitle className="text-blue-400">🎓 The Security Investigator's Guide</CardTitle>
              <CardDescription className="text-blue-300/70">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <Card className="bg-black/50 border-blue-900/50">
                    <CardHeader className="py-4">
                      <CardTitle className="text-lg text-blue-400">🔍 What is Cyber Search?</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <Card className="bg-black/50 border-blue-900/50">
                    <CardHeader className="py-4">
                      <CardTitle className="text-lg text-blue-400">👁️ What Can You See?</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-3">
                      <p className="text-sm text-blue-200/80">
          ...
          <Card className="border-blue-500/30 bg-gradient-to-r from-black to-blue-950/70">
            <CardHeader>
              <CardTitle className="text-blue-400 flex items-center gap-2">
                <div className="text-2xl">👁️</div> Security Watch Special
              </CardTitle>
              <CardDescription className="text-blue-300/70">
                Current cyber threats to monitor in your security environment
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="p-4 border border-blue-900/50 rounded-lg bg-black/30">
                <h4 className="text-blue-400 text-lg mb-2">Common Security Threats</h4>
                <ul className="space-y-3 text-sm text-blue-200/90">
                  <li className="flex items-start gap-2">
                    <div className="text-xl mt-0">📧</div>
                    <div>
                      <p className="font-medium">Phishing Emails</p>
                      <p className="text-xs text-blue-300/70">Scammers sending fake promotional emails with malicious links</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="text-xl mt-0">🦠</div>
                    <div>
                      <p className="font-medium">Malware Distribution</p>
                      <p className="text-xs text-blue-300/70">Malware disguised as legitimate apps, screensavers, and games</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="text-xl mt-0">👤</div>
                    <div>
                      ...
                      <p className="text-xs text-blue-300/70">Abandoned accounts with admin access that hackers can exploit</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="text-xl mt-0">📊</div>
                    <div>
                      ...
                      <p className="text-xs text-blue-300/70">Slow data drainage attacks that extract information over time</p>
                    </div>
                  </li>
                </ul>
              </div>
